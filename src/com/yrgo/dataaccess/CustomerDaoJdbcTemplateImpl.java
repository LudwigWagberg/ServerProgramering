...
public class CustomerDaoJdbcTemplateImpl implements CustomerDao {
    ...
    private void createTables()	{
        try{
            this.template.update("CREATE TABLE CUSTOMER (" +
            ...
            this.template.update("CREATE TABLE TBL_CALL (" +
    ...
    public void create(Customer newCustomer) {
        template.update(INSERT_SQL,newCustomer.getCompanyName(), newCustomer.getEmail(),
